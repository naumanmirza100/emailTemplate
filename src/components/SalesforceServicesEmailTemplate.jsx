...
import { Copy, Download, Eye, CloudCog, CheckCircle2, Mail, Send } from 'lucide-react';
...
const SalesforceServicesEmailTemplate = () => {
  ...
  const [emailSubject, setEmailSubject] = useState('Unlock Salesforce Potential: Certified Services & Expert Staff Augmentation');
          ...
          <div className="mt-6 pt-6 border-t border-slate-100">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input id="recipient-email" type="email" value={recipientEmail} onChange={(e) => setRecipientEmail(e.target.value)} placeholder="recipient@example.com" className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" />
              </div>
              <div>
                <label htmlFor="email-subject" className="block text-sm font-medium text-slate-700 mb-2">Email Subject</label>
                <input id="email-subject" type="text" value={emailSubject} onChange={(e) => setEmailSubject(e.target.value)} placeholder="Email subject" className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" />
              </div>
              <Button onClick={sendEmail} disabled={isSending || !recipientEmail} className="w-full bg-blue-600 hover:bg-blue-700 text-white gap-2">
