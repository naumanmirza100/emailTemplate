...
import { Copy, Download, Eye, Lightbulb, ArrowRight, Mail, Send } from 'lucide-react';
...
const ProductInnovationEmailTemplate = () => {
  ...
  const [emailSubject, setEmailSubject] = useState('Accelerate Growth: Product Innovation & Strategic Staffing');
