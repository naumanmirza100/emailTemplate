  ...
  return (
    <div className="container mx-auto max-w-7xl px-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-xl border border-slate-200 p-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-slate-900">Digital Marketing & Branding</h1>
                <p className="text-slate-500 text-sm">Vibrant, modern template for creative agencies.</p>
              </div>
            </div>
            <div className="flex gap-3">
              ...
              <Button onClick={downloadHTML} className="bg-purple-600 hover:bg-purple-700 text-white">
          ...
          <div className="mt-6 pt-6 border-t border-slate-100">
            ...
            <div className="grid md:grid-cols-2 gap-3">
              <div className="p-3 bg-slate-50 rounded border border-slate-200 text-slate-600 text-sm font-medium cursor-pointer hover:border-purple-300 hover:bg-purple-50 transition-colors" onClick={() => navigator.clipboard.writeText("🚀 Transform Your Brand: Strategic Digital Marketing & Elite Talent")}>
                🚀 Transform Your Brand: Strategic Digital Marketing & Elite Talent
              </div>
              <div className="p-3 bg-slate-50 rounded border border-slate-200 text-slate-600 text-sm font-medium cursor-pointer hover:border-purple-300 hover:bg-purple-50 transition-colors" onClick={() => navigator.clipboard.writeText("Scale Your Marketing Team & Amplify ROI Today")}>
        ...
        {/* Live Preview */}
        {showPreview && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="rounded-xl overflow-hidden border border-slate-200 bg-slate-50 shadow-inner">
            <div className="p-4 flex justify-center bg-slate-100">
              <iframe srcDoc={emailHTML} title="Preview" className="w-full max-w-[720px]" style={{ border: 'none', height: '2200px', background: 'transparent' }} />
            </div>
          </motion.div>
        )}
      </motion.div>
