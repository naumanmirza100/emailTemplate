...
function AppContent() {
  return (
    <>
      ...
      <header className="bg-white/80 backdrop-blur-sm shadow-md sticky top-0 z-50 border-b border-slate-200">
        <div className="container mx-auto px-4 py-3 flex flex-col lg:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-3">
                <Link to="/" className="flex items-center gap-3">
                  ...
                  <div className="border-l border-slate-300 h-6 hidden sm:block"></div>
